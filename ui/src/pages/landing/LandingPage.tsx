...
export default function LandingPage() {
    return (
        <div className="h-screen flex items-center justify-center">
            <div className="m-8 p-4 w-full md:w-2/3 lg:w-2/5 space-y-3 rounded-lg bg-white/60 dark:bg-secondary border-slate-200 dark:border-cool/15 backdrop-blur-md">
