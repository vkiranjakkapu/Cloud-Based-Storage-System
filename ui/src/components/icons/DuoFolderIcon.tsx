...
type DuoFolderSvgIconProps = SVGAttributes<HTMLOrSVGElement> & {
    className?: string;
    focusColor?: string;
    shadowColor?: string;
};

export default function DuoFolderSvgIcon({
    className,
    focusColor,
    shadowColor,
    ...props
}: DuoFolderSvgIconProps) {
    return (
        <svg
        ...
        >
            <path
                ...
                className={
                    shadowColor ?? `text-white/90 dark:text-secondary-accent`
                }
            />
            <path
